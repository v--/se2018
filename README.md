...
Поради спецификите на някои UNIX инструменти, имената на изходните файлове в `topics/` съдържат само номерата на темите. Файловете в `compiled/` са symlink-ове към `build/` директорията, която се създава при построяване. Имената на файловете в `compiled/` са базирани на имената на темите, но не съвпадат тях.
