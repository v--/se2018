...
\begin{definition}
  ...
  \begin{enumerate}
    \item\label{def:poisson_process/increments} Броящият процес \( N(t), t \geq 0 \) наричаме \underLine{поасонов със степен \( \lambda > 0 \)}, ако са изпълнени
    \begin{enumerate}
      \item \( N(0) = 0 \)
    ...
    \item\label{def:poisson_process/limits} Броящият процес \( N(t), t \geq 0 \) наричаме \underLine{поасонов със степен \( \lambda > 0 \)}, ако са изпълнени
    \begin{enumerate}
      \item \( N(0) = 0 \)
