...
\begin{definition}
  ...
  Две случайни величини се наричат \underline{ортогонални}, ако ковариацията им е $0$, защото ковариацията играе ролята на скаларно произведение в пространството от случайни величини с краен втори момент $\LSpace^2$.
...
\begin{definition}
  ...
  Алтернативно, можем да дефинираме $\xi$ чрез индикаторни случайни величина с израза
  \begin{displaymath}
    \xi = \sum_{k \in N} \Ind_k.
  \end{displaymath}

  За простота обикновено считаме, че $N = \{ 1, 2, \ldots, n \}$.
\end{definition}
