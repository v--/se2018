...
Един прост пример за марковска верига с безброй състояния е \uline{случайното блуждаене}, наричано още \uline{случайна разходка}. В този случай множеството от състояния е $\Z$, началното състояние е $0$ с вероятност $1$ и вероятностите за преход са
\begin{displaymath}
  ...
  \end{cases},
\end{displaymath}
където $p_1, p_2, \ldots \in (0, 1)$ е фиксирана редица от вероятности да попаднем в \enquote{дясното} съседно състояние. Обикновено се разглежда еднородно блуждаене, при което $p_1 = p_2 = \cdots = p$ и даже понякога се взима $p = \frac 1 2$.

Очевидно една случайна разходка е неразложима, възвратна и периодична с период $2$.
...
Сумите им $\xi_n \coloneqq \sum_{k=1}^n \eta_k$ тогава образуват еднородно случайно блуждаене.
...
Ако възможните състояния образуват крайно множество $\{ m, m+1, \ldots, M-1, M \}$ от цели числа, състоянията с $m$ и $M$ се наричат \uline{бариери}. Разглеждаме два случая:
\begin{enumerate}
