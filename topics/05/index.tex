...
% Document
\title{Тема 5 от \URL{https://github.com/v--/se2018}}
...
\begin{definition}
  ...
  \begin{enumerate}
    \item Казваме, че функцията \( f(x) \) има \textbf{локален максимум} в точка \( a \in D \), ако за някаква околност \( U_a \) на \( a \) е изпълнено \( f(a) \geq f(u)~\forall u \in U_a \).

    \item Казваме, че функцията \( f(x) \) има \textbf{локален минимум} в точка \( a \in D \), ако за някаква околност \( U_a \) на \( a \) е изпълнено \( f(a) \leq f(u)~\forall u \in U_a \).
