...
\begin{proof}
  ...
  Нека е дадена точката $P_0(x_0, y_0)$, чиито координати удовлетворяват уравнението. Нека $v \in V_2$ е ненулевият вектор с координати $v(B, -A)$. Тогава системата
  \begin{align*}
    l: \begin{cases}
      x = x_0 + \lambda B \\
      y = y_0 - \lambda A,
...
Тук само ще формулираме теоремите, чиито доказателствата са аналогични на тези за прави в равнината.
