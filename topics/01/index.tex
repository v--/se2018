...
\begin{definition}
  Всяко уравнение от вида $Ax + By + C = 0$, където $A, B, C \in \R$, а $A$ и $B$ не се анулират едновременно, наричаме \underline{общо уравнение} на права спрямо $K$.
\end{definition}
...
\begin{proposition}
  Нека координатната система $K = Oxy$ е ортонормирана, нека правата $l$ има спрямо $K$ декартово уравнение $l: y = kx + m$. Дефинираме лъчът $r\Ray : y = kx + m > 0$ върху $l$. Тогава $\tan \angle(r\Ray, Ox) = k$.
\end{proposition}
\begin{proof}
...
\begin{proposition}
  Ако правата $l$ има общо уравнение $l: Ax + By + C = 0$ спрямо $K$, то
  \begin{enumerate}
...
\begin{definition}
  Общото уравнение $l: \alpha x + \beta y + \gamma = 0$ на права $l$ спрямо $K$ се нарича \underline{нормално}, ако е изпълнено условието $\Norm{n(\alpha, \beta)}^2 = \alpha^2 + \beta^2 = 1$.
\end{definition}

\begin{proposition}
  Всяка права $l$ има спрямо $K$ точно две нормални уравнения.
\end{proposition}
\begin{proof}
...
\begin{theorem}
  Нека са дадени точката $P_0(x_0, y_0)$ и правата $l$ с нормално уравнение спрямо $K$
  \begin{displaymath}
...
\begin{definition}
  \underline{Ъгъл между две прави} ще наричаме по-малкия от двата ъгъла, които те сключват.
\end{definition}

\begin{theorem}
  Нека са дадени правите $l_1$ и $l_2$ с нормални уравнения спрямо $K$
  \begin{displaymath}
