...
% Document
\title{Тема 1 от \URL{https://github.com/v--/se2018}}
\subtitle{Уравнение на права и равнина. Формули за разстояния и ъгли. Криви от втора степен.}
\author{Янис Василев}
\date{Оригинал: 11 юни 2019 \\ Ревизия: \gitAbbrevHash{} (\gitAuthorDate) \\ За всеки случай проверете, дали няма по-нова ревизия}
...
\begin{proof}
  ...
  \begin{equation}\label{thm:plane_line_position/matrix_equation}
    ...
    \end{pmatrix},
  \end{equation}
  което ни дава едновременните решения на уравненията (\ref{thm:plane_line_position/scalar_equations}).

  Ако \( \Rank L \neq \Rank \tilde L \), то по теоремата на Руше матричното уравнение (\ref{thm:plane_line_position/matrix_equation}) няма решение, правите \( l_1 \) и \( l_2 \) нямат общи точки и \( l_1 \parallel l_2 \). Обратно, ако правите са успоредни, те нямат общи точки, матричното уравнение (\ref{thm:plane_line_position/matrix_equation}) няма решения и \( \Rank L \neq \Rank \tilde L \).

  Ако \( \Rank L = \Rank \tilde L \), то по теоремата на Руше матричното уравнение (\ref{thm:plane_line_position/matrix_equation}) има поне едно решение. Разглеждаме два случая:
  \begin{enumerate}
    \item Ако \( \Rank L = \Rank \tilde L = 1 \), то редовете на \( L \) са линейно зависими, следователно уравненията (\ref{thm:plane_line_position/scalar_equations}) са еквивалентни и задават едно и също множество. Тъй като и двете са уравнения на прави, те задават една и съща права.
